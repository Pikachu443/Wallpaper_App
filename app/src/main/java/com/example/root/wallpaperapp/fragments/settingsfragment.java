...
public class settingsfragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if(FirebaseAuth.getInstance().getCurrentUser() == null){
            return inflater.inflate(R.layout.notloggedin,container,false);
        }

        return inflater.inflate(R.layout.loggedin,container,false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() != null){
            ...
            ImageView picture = view.findViewById(R.id.imageview);
...
// Initialize Firebase Auth
        ...
        Log.d("lkj", "firebaseAuthWithGoogle:" + acct.getId());
                ...
                .addOnCompleteListener(getActivity(), new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Log.w("lj", "signInWithCredential:failure", task.getException());
